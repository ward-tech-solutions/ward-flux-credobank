...
const navigation = [
  ...
  { name: 'Discovery', href: '/discovery', icon: Scan, roles: ['admin'], feature: 'discovery' },
  { name: 'Map', href: '/map', icon: MapIcon, roles: ['admin', 'regional_manager', 'technician', 'viewer'], feature: 'map' },
  { name: 'Topology', href: '/topology', icon: Network, roles: ['admin', 'regional_manager'], feature: 'topology' },
  ...
  { name: 'Alert Rules', href: '/alert-rules', icon: Bell, roles: ['admin', 'regional_manager'], feature: null },
